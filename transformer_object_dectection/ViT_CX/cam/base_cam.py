...
class BaseCAM:
    def __init__(self,
        ...
        self.featuremap_and_grads = ActivationsAndGradients(
    ...
    def forward(self, input_tensor, target_category=None, eigen_smooth=False):
        ...
        output = self.featuremap_and_grads(input_tensor)
    ...
    def compute_cam_per_layer(
        ...
        activations_list = [a.cpu().data.numpy()
                            for a in self.featuremap_and_grads.featuremaps]
        grads_list = [g.cpu().data.numpy()
                      for g in self.featuremap_and_grads.gradients]
